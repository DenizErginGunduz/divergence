...
is a rolling 14 days; the results below were computed over 114 snapshots and 25 days
from the private mirror, last snapshot 2026-09-24T0515Z. Those are two different
...
|---|---|---|
| Kalshi year-end buckets | 3 of 44 rungs show an edge at quoted prices after both venues' fees, in over 90% of their observations — the weakest in 104 of 108. A quoted-executable discrepancy, not a size-executable one (D-095); no dollar figure is quoted as a trade. | model-free |
...
| Long-horizon touch bound | 0.2% arithmetic violations; 92.8% above the 2x bound | model-dependent, weak |
